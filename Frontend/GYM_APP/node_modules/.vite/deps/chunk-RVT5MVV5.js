...
function useTransition(data, props, deps) {
  ...
  const renderTransitions = (render) => React22.createElement(React22.Fragment, null, transitions.map((t7, i5) => {
    ...
    const key = is.str(t7.key) || is.num(t7.key) ? t7.key : t7.ctrl.id;
...
function c(e8, u5, c10, i5) {
  ...
  var T2 = (0, import_react17.useMemo)(function() {
    ...
    return W3.cancel = function() {
      var r6 = v3.current;
      r6 && (x3 ? cancelAnimationFrame(v3.current) : clearTimeout(v3.current)), f2.current = 0, m3.current = o5.current = d5.current = v3.current = null, r6 && i5 && i5({});
...
//# sourceMappingURL=chunk-RVT5MVV5.js.map
