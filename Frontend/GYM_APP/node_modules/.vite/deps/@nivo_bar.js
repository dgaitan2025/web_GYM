import {
  ...
  wn,
  z
} from "./chunk-RVT5MVV5.js";
import "./chunk-Z65WQCOD.js";
import {
  require_jsx_runtime
...
var X = function(n5) {
  ...
  return function(n6) {
    ...
    if ("native" === e5 || n6 instanceof Date) return s(n6);
...
var E3 = function(t5) {
  ...
  if (e5 && a4.annotations.link.outlineWidth <= 0) return null;
  var l2 = g({}, a4.annotations.link);
  return e5 && (l2.strokeLinecap = "square", l2.strokeWidth = a4.annotations.link.strokeWidth + 2 * a4.annotations.link.outlineWidth, l2.stroke = a4.annotations.link.outlineColor, l2.opacity = a4.annotations.link.outlineOpacity), (0, import_jsx_runtime2.jsx)(animated.path, { fill: "none", d: s, style: l2 });
};
var I = function(t5) {
...
var R3 = function(t5) {
  ...
  if (!W3(e5)) throw new Error("note should be a valid react element");
...
function Q2() {
  return Q2 = Object.assign ? Object.assign.bind() : function(e5) {
    for (var t5 = 1; t5 < arguments.length; t5++) {
      var a4 = arguments[t5];
      for (var i5 in a4) ({}).hasOwnProperty.call(a4, i5) && (e5[i5] = a4[i5]);
    }
    return e5;
...
function U(e5, t5) {
  if (null == e5) return {};
  var a4 = {};
  for (var i5 in e5) if ({}.hasOwnProperty.call(e5, i5)) {
...
var ae = function(i5) {
  ...
  return (0, import_jsx_runtime3.jsxs)(animated.g, { transform: v2, children: [(0, import_jsx_runtime3.jsx)(animated.rect, { width: to(m2, function(e5) {
